...
mod tests {
    ...
    impl GameRepository for InMemoryGameRepository {
        ...
        fn update_if_claimed(&self, _game: &Game, _lock_id: Uuid) -> Result<bool, RepositoryError> {
            Ok(false)
        }

        fn release_progression_claim(&self, _game_uuid: Uuid, _lock_id: Uuid) -> Result<(), RepositoryError> {
            Ok(())
        }
