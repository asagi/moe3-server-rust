...
pub(crate) use error::GetGameResultHandlerError;
...
pub(crate) use game_handler::get_games_result;
...
pub(crate) use super::GameResultOrderResponse;
pub(crate) use super::GameResultPhaseResponse;
pub(crate) use super::GameResultUnitResponse;
...
pub(crate) use super::GetGameResultResponse;
